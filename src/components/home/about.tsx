...
export function About() {
  return (
    <section id="about" className="bg-bg-warm px-10 py-28">
      <div className="mx-auto grid max-w-[1200px] grid-cols-[0.6fr_1fr] items-stretch gap-12">
        ...
        <Reveal
          delay={120}
          className="flex flex-col items-start justify-center gap-6 border-l border-ink/25 pl-12 text-left"
        >
