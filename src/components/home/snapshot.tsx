...
export function Snapshot() {
  ...
  return (
    <section id="snapshot" className="bg-bg-warm px-10 py-[120px]">
      <div className="mx-auto grid max-w-[1180px] items-center gap-20 md:grid-cols-2">
        <div className="flex flex-col gap-5">
          ...
          <h2 className="text-[38px] font-bold leading-[1.2] text-ink">
        ...
        <div className="flex flex-col gap-5 rounded-[20px] border border-[#b9cdcb] bg-bg-mint p-9">
