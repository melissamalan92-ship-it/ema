  ...
  return (
    <section className="relative z-10 bg-navy-primary px-5 sm:px-8 lg:px-20 pb-9 lg:pb-32 pt-10 lg:pt-20">
      <Container>
        ...
        <Reveal className="-mx-5 -mb-14 -mt-[30px] grid grid-cols-3 gap-2 sm:-mx-2 sm:mt-0 sm:gap-3 lg:-mx-[15%] lg:-mb-56 lg:mt-0 lg:gap-5">
          {OFFICE_PHOTOS.map((photo) => (
            ...
            <div key={photo.src}>
              <Image
                ...
                className="aspect-[2/3] w-full rounded-[14px] object-cover sm:aspect-[4/5] lg:aspect-[13/10] transition-transform duration-500 ease-out hover:-translate-y-2 hover:scale-[1.02]"
              />
            </div>
          ))}
        </Reveal>
