...
export function ShoeFoundationHero() {
  return (
    <section className="bg-shoe-blue px-5 pb-10 pt-10 sm:px-8 lg:px-20 lg:pb-20 lg:pt-20">
      ...
      <Container className="grid grid-cols-[120px_1fr] items-center gap-x-24 gap-y-7 lg:grid-cols-[0.6fr_1.4fr] lg:gap-x-12 lg:gap-y-0">
        <Reveal
          delay={120}
        ...
        >
          <p
            data-glow
            className="font-body text-[11.7px] font-bold leading-[1.6] text-cream lg:text-[18px] lg:leading-[1.6]"
          >
