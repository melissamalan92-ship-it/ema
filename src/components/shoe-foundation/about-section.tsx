    ...
    <section className="bg-bg-warm px-10 py-24">
      <div className="mx-auto grid max-w-[1200px] grid-cols-[0.9fr_1.1fr] items-center gap-16">
        <Reveal className="flex flex-col items-center text-center">
          <span className="font-serif text-[110px] font-normal leading-none text-blue-accent">
            42
          </span>
          ...
          <p className="-mt-4 max-w-[280px] font-serif text-[28px] leading-[1.15] text-blue-accent">
        ...
        >
          <h2 className="font-serif text-[40px] font-normal leading-[1.15] tracking-[-0.01em] text-shoe-blue">
